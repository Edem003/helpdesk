    ...
    $.ajax({
        ...
        success: function(response)
        {
            ...
            for(let i = 0; i<response.data.length; i++)
            {
                ...
                let group_members = `${response.data[i].assigned_groupid}`
                ...
                function get_users${response.data[i].id}(val){
                  ...
                  $(document).ready(function() {
                    ...
                    $('#pending_ticket').on('click','.details_${response.data[i].id}',function(){
                        ...
                        <div class="row">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="card" style="border-radius: 5px;">
                                    ...
                                    <form class="form-bookmark needs-validation mt-3" method="POST" action="update_pending_ticket" id="bookmark-form" novalidate="">
                                        <div class="mb-4">
