        ...
        success: function(response)
        {
            for(let i = 0; i<response.data.length; i++)
            {
                ...
                $.ajax({
                    ...
                    {
                        var csrf = data;
                        document.getElementById("csrf_token_handle_a${response.data[i].id}").value = csrf;
                        document.getElementById("csrf_token_handle_b${response.data[i].id}").value = csrf;
                ...
                $(document).ready(function() {
                    ...
                    $('#handle_ticket').on('click','.details_${response.data[i].id}',function(){
                      ...
                      $.ajax({
                        ...
                        success: function(results)
                        {
                          ...
                          document.getElementById('note_id_a${response.data[i].id}').innerHTML = html;
                        }
                      });
                    });
                  })
                </script>
                <div class="text-center"><a href="#" class="btn btn-outline-dark btn-xs details_${response.data[i].id}" type="button" data-bs-toggle="modal" data-bs-target="#handlemodal${response.data[i].id}"><i class="fas fa-info fa-sm" data-container="body" data-bs-toggle="tooltip" data-bs-placement="left" title="View Details"></i></a></div>
                <div class="modal fade" id="handlemodal${response.data[i].id}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                        <div class="modal-header">
                            <div>
                            <ul class="nav main-menu" role="tablist">
                                <li class="me-2"><a class="btn btn-primary-light btn-sm" id="pills-info-tab" data-bs-toggle="pill" href="#pills-info-handle${response.data[i].id}" role="tab" aria-controls="pills-info" aria-selected="true"><i class="fas fa-info-circle fa-fw"></i> Details</a></li>
                                <li class="me-2"><a class="btn btn-primary-light btn-sm show" id="pills-edit-tab" data-bs-toggle="pill" href="#pills-edit-open${response.data[i].id}" role="tab" aria-controls="pills-edit" aria-selected="false"><i class="fas fa-edit fa-fw"></i> Edit</a></li>
                                <li><a class="btn btn-primary-light btn-sm show" id="pills-note-tab" data-bs-toggle="pill" href="#pills-note-handle${response.data[i].id}" role="tab" aria-controls="pills-note" aria-selected="false"><i class="fas fa-sticky-note fa-fw"></i>  Add Note</a></li>
                            </ul>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="pills-info-handle${response.data[i].id}" role="tabpanel" aria-labelledby="pills-info-tab">  
                                <div class="card" style="border-radius: 5px;">
                                    <div class="text-start" style="margin: 10px;">
                                ...
                                <div class="card" style="border-radius: 5px;">
                                    ...
                                    <ul>
                                        <li><p id="note_id_a${response.data[i].id}"></p></li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="card" style="border-radius: 5px;">
                                    ...
                                    <form class="form-bookmark needs-validation mt-3" method="POST" action="update_handle_ticket" id="bookmark-form" novalidate="">
                                        <div class="mb-3">
                                        <input type="text" id="csrf_token_handle_a${response.data[i].id}" name="_token" hidden>
                            ...
                            <div class="fade tab-pane" id="pills-note-handle${response.data[i].id}" role="tabpanel" aria-labelledby="pills-note-tab">                                    
                                <div class="card" style="border-radius: 5px;">
                                <div class="text-start" style="margin: 10px;">
                                    <h6 class="text-warning small">NOTE</h6>
                                    ...
                                    <div class="row">
                                    <div class="mb-3">
                                        <input type="text" id="csrf_token_handle_b${response.data[i].id}" name="_token" hidden>
                                        <label class="col-form-label pt-0" for="exampleInputEmail1">Ticket ID<span class="text-danger">*</span></label>
                                        <input class="form-control" id="exampleInputEmail1" type="text" name="code" value="${response.data[i].code}" readonly required>
                                    </div>
                                    <div class="mb-0 mt-3">
