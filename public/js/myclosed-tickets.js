        ...
        success: function(response)
        {
            for(let i = 0; i<response.data.length; i++)
            {
                ...
                $.ajax({
                    ...
                    {
                        var csrf = data;
                        document.getElementById("csrf_token_myclosed${response.data[i].id}").value = csrf;
                ...
                $(document).ready(function() {
                    ...
                    $('#myclosed_ticket').on('click','.details_${response.data[i].id}',function(){
                      ...
                      $.ajax({
                        ...
                        success: function(results)
                        {
                          ...
                          document.getElementById('note_id_e${response.data[i].id}').innerHTML = html;
                        }
                      });
                    });
                  })
                        ...
                        <div class="row">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="card" style="border-radius: 5px;">
                                    ...
                                    <ul>
                                        <li><p id="note_id_e${response.data[i].id}"></p></li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
