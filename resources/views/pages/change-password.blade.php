...
<html lang="en">
  ...
  <!-- Loader ends-->
<!-- page-wrapper Start-->
  <body class="custom-scrollbar" style="font-family: SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace; background-color: #d1e1d4;">
    <!-- Loader starts-->
          ...
          <div class="row" style="display: flex; justify-content: center; align-items: center; min-height: 100vh;">
                  <div class="col-xl-6">
                      <div class="card">
                          ...
                          <form class="form-bookmark needs-validation col-md-10" method="POST" action="n_change_password" id="bookmark-form" novalidate="">
                          @csrf
                            ...
                            @endif
                                ...
                                <div class="mb-3">
                                  <label class="col-form-label pt-0" for="exampleInputEmail1">Confirm Password<span class="text-danger">*</span></label>
                                  <input class="form-control" id="exampleInputEmail1" type="password" name="cf_pass" required="" minlength="8" placeholder="*************">
                                </div>
                                <div class="row">
                                  <div class="col-md-5">
                                    <button class="btn btn-primary btn-update" type="submit"><i class="fas fa-undo small"></i> Update</button>
                                  </div>
                                  <div class="col-md-7" style="padding-top: 30px">
                                    <p>Do you have an account?<a class="ms-2" href="welcome" style="text-decoration: underline"><b>Login Here</b></a></p>
                                  </div>
                                </div>
                                <div class="row">
